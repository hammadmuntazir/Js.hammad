...
// console.log(balance.toString().length);
 //console.log(balance.toFixed(2));//for percision value used in ecommerence website etc
...
//ljj console.log(Math.round(4.6))//will do round off
...
// // lets suppose i am playing a game and i want vales between some numbers
